...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_accompanimentMenuFragment2_to_checkoutFragment2)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_accompanimentMenuFragment2_to_startOrderFragment2)
    }
