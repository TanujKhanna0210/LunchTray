...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_sideMenuFragment2_to_accompanimentMenuFragment2)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_sideMenuFragment2_to_startOrderFragment2)
    }
